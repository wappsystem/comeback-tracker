(function(){
    ...
    m[p+"people-data"] ={url:H+"/form-grid/people-data.html",Table:"people-comeback",form_module:"people-form",task_name:"People",online_questionnaire:"oq",online_new_questionnaire:"oq-new"};                   
    ...
    m[p+"oq-new"] ={url:I+"/questionnaire-new.html",task_name:"Questionnaires"},
    ...
    m[p+"questionnaire-new-data"] ={url:H+"/form-grid/questionnaire-new-data.html",Table:"questionnaire-new-comeback",form_module:"questionnaire-new-form",task_name:"Questionnaire"};                   
    m[p+"questionnaire-new-form"] ={url:H+"/form-grid/questionnaire-new-form.html",Table:"questionnaire-new-comeback",task_name:"Questionnaire"};
    m[p+"panel-oq"]=              {url:H+"/panels/oq.html"}  ,  
    m[p+"panel-oq-new"]=              {url:H+"/panels/oq-new.html"}  ,  
